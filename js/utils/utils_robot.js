...
export class XArm7Robot extends RobotBaseClass {
    ...
    get_robot_joints() {
        ...
        let joint12 = new RobotJointRevolute('drive_joint', 12, 12, 13, 8, [[1], [0], [0]], 0.0, 0.44, [0.0, 0.035, 0.059098], [0,0,0]);
        ...
        let joint14 = new RobotJointRevolute('left_inner_knuckle_joint', 14, 12, 15, 8, [[1], [0], [0]], 0.0, 0.44, [0.0, 0.02, 0.074098] , [0,0,0]);
        //let joint15 = new RobotJointFixed('right_outer_knuckle_joint', 15, 12, 16, [0.0, -0.035, 0.059098] , [0,0,0]);
        let joint15 = new RobotJointRevolute('right_outer_knuckle_joint', 15, 12, 16, 8, [[-1], [0], [0]], 0.0, 0.44, [0.0, -0.035, 0.059098] , [0,0,0]);
